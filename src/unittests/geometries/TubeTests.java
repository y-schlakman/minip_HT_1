...
class TubeTests {
    ...
    void getNormal() {
        ...
        // =============== Boundary Values Tests ==================
        //TC11: Test if getNormal() returns the correct answer for points that form 90 degree angle with axis ray when connected to ray's head
